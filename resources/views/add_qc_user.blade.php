                ...
                <div class="panel-heading">
                    <div class="row" id="form_title">
                        <div class="col col-sm-3 col-xs-12">
                            <h5 class="title">Add Qc User<span></span></h5>
...
<div class="container-fluid">
    ...
    <form action="{{ route('add_qc_user') }}" method="POST" class="modern-form" id="add_admin_form" action="/upload" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row mb-2">
        <div class="col">
            <label for="user_reg_no" class="form-label">QC Reg No</label>
