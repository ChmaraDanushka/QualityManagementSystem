...
<div class="container-fluid">
    ...
    <form action="{{ route('update_admin') }}" method="POST" class="modern-form" id="add_admin_form" enctype="multipart/form-data">
    {{ @csrf_field() }}
    {{@method_field('PUT')}}
    ...
    <div class="row mb-2">
        <div class="col">
            ...
            <input type="text" class="form-control" id="signUpFirst" name="user_reg_no" value="{{$data->user_reg_no}}">
  ...
  <div class="round-profile">
    <img src="{{ asset('uploads/admin_pro/' . $data->user_profile_picture) }}" id="selected_image" alt="Image" title="Image Title" style="max-width: 100%; height: auto;">
  </div>
</span>
        </span><br>
    ...
    <div class="row mb-2">
        <div class="col">
            ...
            <input type="text" class="form-control" id="signUpFirst" name="user_first_name" value="{{$data->user_first_name}}">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" id="signUpLast" name="user_last_name" value="{{$data->user_last_name}}">
    ...
    <div class="row mb-2">
        <div class="col">
            ...
            <input type="text" class="form-control" id="user_nic" name="user_nic" value="{{$data->user_nic}}">
    ...
    <div class="row mb-2">
        <div class="col">
            ...
            <input type="text" class="form-control" id="user_address" name="user_address" value="{{$data->user_address}}">
    ...
    <div class="row mb-2">
        <div class="col">
            ...
            <input type="email" class="form-control" id="email" name="user_email" value="{{$data->user_email}}">
        ...
        <div class="col">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" aria-label="Telephone" aria-describedby="basic-addon1"
                    name="user_tp_number"  value="{{$data->user_tp}}">
            </div>
    ...
    <div class="col">
        ...
        <select class="form-control" id="user_level" name="user_level" value="{{$data->user_reg_no}}">
