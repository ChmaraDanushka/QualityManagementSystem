...
<head>
    ...
    <title>Crystal Pack Privet Limited Quality :: Admin</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">CRYSTAL PACK QUALITY</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('add_admin') }}">Add Admins</a>
                        <a class="collapse-item" href="{{ route('admin_view') }}">View Admins</a>
                        <a class="collapse-item" href="{{ route('user_log') }}">Log List</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage QC:</h6>
                        <a class="collapse-item" href="{{ route('add_qc_user') }}">Add QC</a>
                        <a class="collapse-item" href="{{ route('qc_view') }}">View QC</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesT" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">MANAGE SHEET EXTRUDER</h6>
                        <a class="collapse-item" href="{{ route('sheet_mc_add') }}">Matchines</a>
                        <a class="collapse-item" href="{{ route('sheet_material_add') }}">Matirial</a>
                        <a class="collapse-item" href="{{ route('sheet_product') }}">Add Product</a>
                        <a class="collapse-item" href="{{ route('sheet_product_list') }}">Product list</a>
                        <a class="collapse-item" href="{{ route('sheet_ongoing') }}">Ongoing Products</a>
                        <a class="collapse-item" href="{{ route('sheet_all_quality_pro') }}">Quality</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesS" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">MANAGE THERMO FORMING</h6>
                        <a class="collapse-item" href="{{ route('thermo_mc_add') }}">Matchines</a>
                        <a class="collapse-item" href="{{ route('thermo_product_add') }}">Add Product</a>
                        <a class="collapse-item" href="{{ route('thermo_product_list') }}">Products List</a>
                        <a class="collapse-item" href="{{ route('thermo_ongoing_checlist') }}">Ongoing Products</a>
                        <a class="collapse-item" href="{{ route('thermo_all_checklist') }}">Quality</a>
            ...
            <li class="nav-item">
                ...
                <div id="Promotions" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">MANAGE PRINTING</h6>
                        <a class="collapse-item" href="{{ route('printing_add_mc') }}">Matchines</a>
                        <a class="collapse-item" href="{{ route('print_customers_add') }}">Add Product</a>
                        <a class="collapse-item" href="{{ route('print_customers_list') }}">Products List</a>
                        <a class="collapse-item" href="{{ route('print_list_ongoing') }}">Ongoing Products</a>
                        <a class="collapse-item" href="{{ route('print_list_all') }}">Quality</a>
            ...
            <li class="nav-item d-none">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#foilPrinter" aria-expanded="true" aria-controls="foilPrinter">
                    <i class="fa fa-file"></i>
                    <span>REPORTS</span>
                </a>
                <div id="foilPrinter" class="collapse" aria-labelledby="headingFoilPrinter" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item  d-none">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#foilCutter" aria-expanded="true" aria-controls="foilCutter">
                    <i class="fa fa-file"></i>
                    <span>FOIL CUTTER</span>
                </a>
                <div id="foilCutter" class="collapse" aria-labelledby="headingFoilCutter" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">MANAGE CUTTERS</h6>
                        <a class="collapse-item" href="{{ route('testing') }}">Machines</a>
            ...
            <li class="nav-item d-none">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#paperCup" aria-expanded="true" aria-controls="paperCup">
                    <i class="fa fa-file"></i>
                    <span>PAPER CUP</span>
                </a>
                <div id="paperCup" class="collapse" aria-labelledby="headingPaperCup" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item d-none">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#spoon" aria-expanded="true" aria-controls="spoon">
                    <i class="fa fa-file"></i>
                    <span>SPOON</span>
                </a>
                <div id="spoon" class="collapse" aria-labelledby="headingSpoon" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">VACUUM SPOON</h6>
                        <a class="collapse-item" href="{{ route('testing') }}">Machines</a>
                        <a class="collapse-item" href="{{ route('testing') }}">Products</a>
                        <a class="collapse-item" href="{{ route('testing') }}">Ongoing Products</a>
                        <a class="collapse-item" href="{{ route('testing') }}">Quality</a>
            ...
            <li class="nav-item ">
                ...
                <div id="reports" class="collapse" aria-labelledby="headingreports" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage Reports:</h6>
                        <a class="collapse-item" href="{{ route('sheet-extruder-report') }}">Sheet Extruder Report</a>
                        <a class="collapse-item" href="{{ route('thermo-form-report') }}">Thermo Forming Report</a>
                        <a class="collapse-item" href="{{ route('printing-report') }}">Printing Report</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-black-600 small">{{ session('AName') }}</span>
